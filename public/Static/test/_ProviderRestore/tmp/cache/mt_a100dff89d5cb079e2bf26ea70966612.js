			...
			switch (n) {
				case 'cmslinker':
					var c = cm.createMenuButton('cmslinker', {
						title : 'CMSMS Linker',
						image : 'http://beaupotager.com/modules/MicroTiny/images/cmsmslink.gif',
						icons : false
					});
  ...
  body_class : "CMSMSBody",
      content_css : "http://beaupotager.com/tmp/cache/stylesheet_combined_b673e1cecc82e9f00c1b136407a70715.css,http://beaupotager.com/tmp/cache/stylesheet_combined_29b23304e735cd73b6282d528a45fafb.css",
  ...
  document_base_url : "http://beaupotager.com/",
...
function CMSMSFilePicker (field_name, url, type, win) {
  ...
  var cmsURL = "http://beaupotager.com/admin/moduleinterface.php?mact=MicroTiny,,filepicker,0&_sx_=df7ae026&type="+type+"&showtemplate=false";
