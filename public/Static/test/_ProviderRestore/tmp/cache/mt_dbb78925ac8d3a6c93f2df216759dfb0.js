			...
			switch (n) {
				case 'cmslinker':
					var c = cm.createMenuButton('cmslinker', {
						title : 'CMSMS Linker',
						image : 'http://www.beaupotager.fr/modules/MicroTiny/images/cmsmslink.gif',
						icons : false
					});
  ...
  body_class : "CMSMSBody",
      content_css : "http://www.beaupotager.fr/tmp/cache/stylesheet_combined_b673e1cecc82e9f00c1b136407a70715.css,http://www.beaupotager.fr/tmp/cache/stylesheet_combined_29b23304e735cd73b6282d528a45fafb.css",
  ...
  document_base_url : "http://www.beaupotager.fr/",
...
function CMSMSFilePicker (field_name, url, type, win) {
  ...
  var cmsURL = "http://www.beaupotager.fr/admin/moduleinterface.php?mact=MicroTiny,,filepicker,0&_sx_=d594529a&type="+type+"&showtemplate=false";
