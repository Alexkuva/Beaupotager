...
<?php /*%%SmartyHeaderCode:7474072751f3bfcf2e4f97-94704018%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '7474072751f3bfcf2e4f97-94704018',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_51f3bfcf494341_20472597',
  'variables' => 
  array (
    'display_slider' => 0,
...
<?php if ($_valid && !is_callable('content_51f3bfcf494341_20472597')) {function content_51f3bfcf494341_20472597($_smarty_tpl) {?><?php if (!is_callable('smarty_function_anchor')) include '/homepages/26/d480780604/htdocs/plugins/function.anchor.php';
if (!is_callable('smarty_function_root_url')) include '/homepages/26/d480780604/htdocs/plugins/function.root_url.php';
if (!is_callable('smarty_function_sitename')) include '/homepages/26/d480780604/htdocs/plugins/function.sitename.php';
if (!is_callable('smarty_function_breadcrumbs')) include '/homepages/26/d480780604/htdocs/plugins/function.breadcrumbs.php';
if (!is_callable('Search::function_plugin')) include '/homepages/26/d480780604/htdocs/plugins/function.search.php';
if (!is_callable('News::function_plugin')) include '/homepages/26/d480780604/htdocs/plugins/function.news.php';
if (!is_callable('smarty_function_valid_css')) include '/homepages/26/d480780604/htdocs/plugins/function.valid_css.php';
...
<body>
    ...
    <!-- TEMPLATE BLOCKS --> 
<?php CMS_Content_Block::smarty_internal_fetch_contentblock(array('block'=>"Display Header Slider",'oneline'=>"true",'size'=>"1",'default'=>"-",'assign'=>"display_slider",'tab'=>'Header','wysiwyg'=>'false'),$_smarty_tpl); ?>
...
$_smarty_tpl->tpl_vars["display_slider"]->value = "-"; $_smarty_tpl->tpl_vars["display_slider"]->nocache = null; $_smarty_tpl->tpl_vars["display_slider"]->scope = 0;
    ...
    <?php $_smarty_tpl->_capture_stack[0][] = array('default', "galleryfolder", null); ob_start(); ?><?php CMS_Content_Block::smarty_internal_fetch_contentblock(array('block'=>"galleryfolder",'oneline'=>"true",'label'=>"Gallery Module foldername for Header Slideshow",'tab'=>'Header','wysiwyg'=>'false'),$_smarty_tpl); ?><?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?>
    <?php CMS_Content_Block::smarty_internal_fetch_contentblock(array('block'=>"Display Breadcrumbs",'oneline'=>"true",'size'=>"1",'default'=>"+",'assign'=>"display_breadcrumbs",'tab'=>'Header','wysiwyg'=>'false'),$_smarty_tpl); ?>
...
$_smarty_tpl->tpl_vars["display_breadcrumbs"]->value = "+"; $_smarty_tpl->tpl_vars["display_breadcrumbs"]->nocache = null; $_smarty_tpl->tpl_vars["display_breadcrumbs"]->scope = 0;
    ...
    <?php CMS_Content_Block::smarty_internal_fetch_contentblock(array('block'=>"Display Sidebar Menu",'oneline'=>"true",'size'=>"1",'default'=>"+",'assign'=>"display_sidebar_menu",'tab'=>'Sidebar','wysiwyg'=>'false'),$_smarty_tpl); ?>
...
$_smarty_tpl->tpl_vars["display_sidebar_menu"]->value = "+"; $_smarty_tpl->tpl_vars["display_sidebar_menu"]->nocache = null; $_smarty_tpl->tpl_vars["display_sidebar_menu"]->scope = 0;
    ...
    <?php CMS_Content_Block::smarty_internal_fetch_contentblock(array('block'=>"Display Search",'oneline'=>"true",'size'=>"1",'default'=>"+",'assign'=>"display_search",'tab'=>'Header','wysiwyg'=>'false'),$_smarty_tpl); ?>
...
$_smarty_tpl->tpl_vars["display_search"]->value = "+"; $_smarty_tpl->tpl_vars["display_search"]->nocache = null; $_smarty_tpl->tpl_vars["display_search"]->scope = 0;
    ...
    <?php CMS_Content_Block::smarty_internal_fetch_contentblock(array('block'=>"Display News",'oneline'=>"true",'size'=>"1",'default'=>"+",'assign'=>"display_news",'tab'=>'Sidebar','wysiwyg'=>'false'),$_smarty_tpl); ?>
...
$_smarty_tpl->tpl_vars["display_news"]->value = "+"; $_smarty_tpl->tpl_vars["display_news"]->nocache = null; $_smarty_tpl->tpl_vars["display_news"]->scope = 0;
    ...
    <?php CMS_Content_Block::smarty_internal_fetch_contentblock(array('block'=>"Sliding News on/off",'oneline'=>"true",'size'=>"1",'default'=>"+",'assign'=>"display_news_slider",'tab'=>'Sidebar','wysiwyg'=>'false'),$_smarty_tpl); ?>
...
$_smarty_tpl->tpl_vars["display_news_slider"]->value = "+"; $_smarty_tpl->tpl_vars["display_news_slider"]->nocache = null; $_smarty_tpl->tpl_vars["display_news_slider"]->scope = 0;
    ...
    <?php CMS_Content_Block::smarty_internal_fetch_contentblock(array('block'=>"Display To Top of the page link",'oneline'=>"true",'size'=>"1",'default'=>"+",'assign'=>"display_to_top",'tab'=>'Footer','wysiwyg'=>'false'),$_smarty_tpl); ?>
...
$_smarty_tpl->tpl_vars["display_to_top"]->value = "+"; $_smarty_tpl->tpl_vars["display_to_top"]->nocache = null; $_smarty_tpl->tpl_vars["display_to_top"]->scope = 0;
    ...
    <?php CMS_Content_Block::smarty_internal_fetch_contentblock(array('block'=>"Display Footer Menu",'oneline'=>"true",'size'=>"1",'default'=>"+",'assign'=>"display_footer_menu",'tab'=>'Footer','wysiwyg'=>'false'),$_smarty_tpl); ?>
...
$_smarty_tpl->tpl_vars["display_footer_menu"]->value = "+"; $_smarty_tpl->tpl_vars["display_footer_menu"]->nocache = null; $_smarty_tpl->tpl_vars["display_footer_menu"]->scope = 0;
    ...
    <?php CMS_Content_Block::smarty_internal_fetch_contentblock(array('block'=>"Display Validation Icons",'oneline'=>"true",'size'=>"1",'default'=>"+",'assign'=>"display_validation",'tab'=>'Footer','wysiwyg'=>'false'),$_smarty_tpl); ?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array('default', 'pagetitle', null); ob_start(); ?><?php CMS_Content_Block::smarty_internal_fetch_contentblock(array('block'=>'Main Page Title','description'=>'H2 Title on a page frontend','wysiwyg'=>"false",'oneline'=>"true",'tab'=>'Main'),$_smarty_tpl); ?><?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <ul class="accessibility">
      <li><?php echo smarty_function_anchor(array('anchor'=>'subNav','title'=>'Skip to navigation','accesskey'=>'n','text'=>'Skip to navigation'),$_smarty_tpl);?>
</li>
...
" src="/uploads/tpl-buddy-001/logo.png" /></a></h1>
        ...
        <div id="mainNav"> 
          ...
          <?php echo MenuManager::function_plugin(array('loadprops'=>0,'number_of_levels'=>'1'),$_smarty_tpl);?>
    ...
    <div id="sliderWrapper">
      <div class="bannerHolder">
        ...
        <a href="#"><span id="nextBanner">Next</span></a> 	
		  ...
		  <?php echo Gallery::function_plugin(array('template'=>"buddySlider",'dir'=>'slider'),$_smarty_tpl);?>
	  ...
	  <!-- SIDE NAVIGATION (SUBMENU) -->          
          <div id="subNav">
            ...
            <?php if ($_smarty_tpl->tpl_vars['display_sidebar_menu']->value=="+"){?>
              <?php echo MenuManager::function_plugin(array('loadprops'=>0,'start_level'=>'2','collapse'=>'1'),$_smarty_tpl);?>
...
<!-- <h2>Infos</h2>--> 
            ...
            <?php echo News::function_plugin(array('number'=>'2','moretext'=>"En savoir plus"),$_smarty_tpl);?>
 
          </div>
          <?php }?>


<a class="twitter-timeline"  href="https://twitter.com/BEAUPOTAGER"  data-widget-id="361139390489178112"><img alt="<?php echo smarty_function_sitename(array(),$_smarty_tpl);?>
" src="/uploads/tpl-buddy-001/icone.gif" />Suivez-nous sur Twitter</a>
          ...
          <?php CMS_Content_Block::smarty_internal_fetch_contentblock(array('block'=>'sidebar','label'=>'Sidebar content block (to hide this block just leave it empty)','assign'=>'sidecontent','tab'=>'Sidebar'),$_smarty_tpl); ?>
      ...
      <div id="footer" class="span-950">
        ...
        <div class="footer-icons">
          <div class="validation"> 
            <?php echo smarty_function_valid_css(array('image'=>'false','class'=>'valid-css','target'=>'_blank','text'=>'valid css3'),$_smarty_tpl);?>

            <?php echo smarty_function_valid_xhtml(array('image'=>'false','class'=>'valid-xhtml','target'=>'_blank'),$_smarty_tpl);?>
